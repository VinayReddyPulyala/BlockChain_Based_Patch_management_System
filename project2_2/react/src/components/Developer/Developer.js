    ...
    return (
        <div className="container my-5">
                ...
                <div className="container-fluid">
                    <ul className="navbar-nav w-100">
                        <li className="nav-item col-sm text-center active">
                            <Link className="nav-link col-12 text-dark" aria-current="page" to="/Developer/Requests">Patch Requests</Link>
                        </li>
            ...
            <div className="border border-secondary">
                <DeveloperContext.Provider value={{ contract: contractdata, Account: account }}>
                    <Outlet />
