    ...
    return (
        <div className="container my-5">
                ...
                <div className="container-fluid">
                    <ul className="navbar-nav w-100">
                        <li className="nav-item col-sm text-center active">
                            <Link className="nav-link col-12 text-dark" aria-current="page" to="/verifier">Unchecked</Link>
                        </li>
            ...
            <div className="container border border-secondary p-3" id="cards">
                <VerifierContext.Provider value={{ contract: contractdata, Account: account }}>
                    <Outlet />
